        ...
        <div className="auth-layout">
            ...
            >
                ...
                <div style={{ marginTop: '48px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
                    <div>
                        <div style={{ fontSize: '1.2rem', fontWeight: 800, color: 'white', marginBottom: '4px' }}>99.9%</div>
                        <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>{t('uptime_label')}</p>
                    </div>
                    <div>
                        <div style={{ fontSize: '1.2rem', fontWeight: 800, color: 'white', marginBottom: '4px' }}>AES-256</div>
                        <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>{t('secure_label')}</p>
                    </div>
                </div>
            </motion.div>
            ...
            <div className="auth-form-side">
                ...
                >
                    <div style={{ marginBottom: '28px' }}>
                        <h1 className="title-gradient title-font" style={{ fontSize: '1.7rem', fontWeight: 800, marginBottom: '6px' }}>{t('login_title')}</h1>
                        <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem' }}>{t('login_prompt')}</p>
                    </div>
